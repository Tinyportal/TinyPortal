	...
	<div>
		...
		echo '
			...
			<div class="catbg addborderleft" style="padding:0px;">
				...
				<div align="center" class="float-items title-admin-area" style="width:10%;">', $context['TPortal']['tpsort']=='comments' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';area=tparticles;tpsort=comments">'.$txt['tp-comments'].'</a></div>
...
<div class="title_bar">
	...
	echo '
			...
			<div class="catbg addborderleft" style="padding:0px;">
				<div align="center" style="width:17%;" class="float-items pos">', $context['TPortal']['tpsort']=='name' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=name">'.$txt['subject'].'</a></div>
				<div align="center" style="width:19%;" class="float-items title-admin-area">', ($context['TPortal']['tpsort']=='created'  || $context['TPortal']['tpsort']=='') ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=created">'.$txt['date'].'</a></div>
				<div align="center" style="width:14%;" class="float-items title-admin-area">', $context['TPortal']['tpsort']=='views' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=views">'.$txt['views'].'</a></div>
				<div align="center" style="width:14%;" class="float-items title-admin-area">'.$txt['tp-ratings'].'</div>
				<div align="center" style="width:14%;" class="float-items title-admin-area">', $context['TPortal']['tpsort']=='downloads' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=downloads">'.$txt['tp-downloads'].'</a></div>
			...
			<div class="windowbg2 addborder">
				...
				<div class="box" style="width:81%;float:left;">				
				  ...
				  <div style="width:18%;" class="fullwidth-on-res-layout float-items" align="center">
				    <div id="show-on-respnsive-layout">', $context['TPortal']['tpsort']=='views' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=views">'.$txt['views'].'</a></div>
				    ',$art['views'],'
				  </div>
				  ...
				  <div style="width:18%;" class="fullwidth-on-res-layout float-items" align="center">
				   ...
				   <div style="width:12%;" class="fullwidth-on-res-layout float-items" align="center">
				    <div id="show-on-respnsive-layout">'. $txt['tp-edit'] .'</div>
				     ' , $art['editlink']!='' ? '<a href="'.$art['editlink'].'"><img border="0" src="' .$settings['tp_images_url']. '/TPedit.gif" alt="" /></a>' : '' , '
				   </div>
			       <p class="clearthefloat"></p>
				</div>
				<p class="clearthefloat"></p>		   
