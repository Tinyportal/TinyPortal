(function () {
	...
	sceditor.locale['ru'] = {
		...
		'Enter the image URL:': 'Введите URL-адрес изображения:',
		'Enter the e-mail address:': 'Введите адрес электронной почты:',
		'Enter the displayed text:': 'Введите отображаемый текст:',
		'Enter URL:': 'Введите URL:',
		'Enter the YouTube video URL or ID:': 'Введите URL видео на YouTube или ID:',
		'Invalid YouTube video': 'Недопустимое видео YouTube',
		'Add indent': 'Добавить отступ',
		'Remove one indent': 'Удалить один отступ',
		'Maximize': 'Развернуть',
