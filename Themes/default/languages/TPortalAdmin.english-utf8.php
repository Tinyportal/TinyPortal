...
$txt['tp-adminiconsinfo'] = 'PNG, JPG or GIF, Max-size: ' .$context['TPortal']['icon_max_size']. ' KB. Images will be resized so the shortest side is 128 px, while retaining aspect ratio. Note that the top area of the image will be used as article icon.';
