...
$txt['tp-front_placement_standalone_url'] = 'Standalone page url:';
$txt['tp-front_placement_standalone_url2'] = 'This option lets you place the TinyPortal outside of the forum.<br>To use this mode, first open \'TPStandalone.php\' and change the \'$boarddir\' to the SMF\'s installation directory.<br>Then you can rename and put the \'TPStandalone.php\' to the location you want the portal displayed.<br>After you placed the file, enable the Standalone mode above and write the URL that points to the file.<br>Note: Make sure to configure the \'Enable local storage of cookies\' and \'Use subdomain independent cookies\' options on the \'Cookies and Sessions\' page.';
