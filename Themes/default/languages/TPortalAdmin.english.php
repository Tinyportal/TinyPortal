...
$txt['tp-use_promote'] = 'Activate Promote topic function throughout the forum';
$txt['tp-use_promotedesc'] = 'This setting will activate the use of an extra button in forum topics, allowing users that can manage TinyPortal settings to select topics to be set to \'Promoted topic \'. Promoted topics can be shown on the Frontpage or in blocks.';
...
$txt['tp-admin_showblocksdesc'] = 'If a user has the Administrator as primary membergroup, this user will by default see ALL active TinyPortal blocks. The setting \'Admin can see all blocks\' can be used disable this behaviour for Administrators. The standard behaviour in TinyPortal is:
...
$txt['tp-front_placement_disabled'] = 'Do not display the frontpage. (Go directly to forum index.)';
$txt['tp-front_placement_url'] = 'Standalone page url:';
$txt['tp-front_placement_url2'] = 'This option lets you place the TinyPortal outside of the forum.<br><br>To use this mode, first open \'TPStandalone.php\' and change the \'$boarddir\' to the SMF\'s installation directory.<br><br>Then you can rename and put the \'TPStandalone.php\' to the location you want the portal displayed.<br><br>After you place the file, enable the Standalone mode above and write the URL that points to the file.<br><br>Note: Make sure to configure the \'Enable local storage of cookies\' and \'Use subdomain independent cookies\' options on the \'Cookies and Sessions\' page.';
$txt['tp-frontpage_standalone_mode'] = 'TinyPortal Standalone Mode';
$txt['tp-frontpage_standalone_mode_text'] = 'Standalone Mode is not enabled. To enable standalone mode, visit the ';
...
$txt['tp-iconmaxsize'] = 'Max size for uploading article icons';
$txt['tp-imagemaxsize'] = 'Max size for uploading article images';
$txt['tp-maxsize'] = 'File size limit';
...
$txt['tp-userbox8'] = 'Login form with captions';
...
$txt['tp-showuserbox3'] = 'Login form layout';
...
$txt['tp-shoutbox_barposition'] = 'Position of the post bar';
$txt['tp-shoutbox_barpositiontop'] = 'Top';
$txt['tp-shoutbox_barpositionbottom'] = 'Bottom';
$txt['tp-shoutbox_direction'] = 'Position of new messages';
$txt['tp-shoutbox_directiontop'] = 'Top';
$txt['tp-shoutbox_directionbottom'] = 'Bottom';
...
$txt['tp-shoutboxtimeformatdesc'] = 'Time Format: You have the ability to adjust how the time and date look for yourself. There are a lot of little letters, but it\'s quite simple. The conventions follow PHP\'s strftime function and are described at php.net: https://www.php.net/manual/en/function.strftime.php. The following characters are recognized in the format string: %a - abbreviated weekday name, %A - full weekday name, %b - abbreviated month name, %B - full month name, %d - day of the month (01 to 31), %D* - same as %m/%d/%y, %e* - day of the month (1 to 31), %H - hour using a 24-hour clock (range 00 to 23), %I - hour using a 12-hour clock (range 01 to 12), %m - month as a number (01 to 12), %M - minute as a number, %p - either &quot;AM&quot; or &quot;PM&quot; according to the given time, %R* - time in 24 hour notation, %S - two digit representation of the second, %T* - current time, equal to %H:%M:%S, %y - 2 digit year (00 to 99), %Y - 4 digit year, %% - a literal \'%\' character (* Does not work on Windows-based servers.)';
