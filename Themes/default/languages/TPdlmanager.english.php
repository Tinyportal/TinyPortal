...
$txt['tp-dlperms2'] = 'Select and set permissions on all membergroups from one place. "Manage Downloads" give admin rights for all downloads, "Upload file" give permission to actually upload, while "create topic" give permission to start a forum topic at the the time of upload.';
