...
//FTP
$txt['tp-dlftp'] = 'FTP';
$txt['tp-ftpstrays'] = 'These files are not assigned in the tp_dlmanager table:';
...
$txt['tp-dlheader2'] = 'You can create categories here, edit each one with permissions, names and icons and upload files into them. There is also a ftp screen where you can assign pre-uploaded files to an existing item or category. Submitted files screen can also be found here, it allows you to either approve or reject(delete) them.';
