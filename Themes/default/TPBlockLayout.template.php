...
function template_tp_above()
{
	...
	if (isset($context['TPortal']['block_layout_left'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_left'], ['horiz2', 'horiz3', 'horiz4'])) {
	...
	if (isset($context['TPortal']['block_layout_right'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_right'], ['horiz2', 'horiz3', 'horiz4'])) {
	...
	if (isset($context['TPortal']['block_layout_top'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_top'], ['horiz2', 'horiz3', 'horiz4'])) {
	...
	if (isset($context['TPortal']['block_layout_center'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_center'], ['horiz2', 'horiz3', 'horiz4'])) {
...
function template_tp_below()
{
	...
	if (isset($context['TPortal']['block_layout_lower'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_lower'], ['horiz2', 'horiz3', 'horiz4'])) {
	...
	if (isset($context['TPortal']['block_layout_bottom'])) {
		...
		elseif (in_array($context['TPortal']['block_layout_bottom'], ['horiz2', 'horiz3', 'horiz4'])) {
