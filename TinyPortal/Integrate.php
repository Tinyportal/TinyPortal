...
class Integrate 
{
    ...
    public static function hookPermissions(&$permissionGroups, &$permissionList, &$leftPermissionGroups, &$hiddenPermissions, &$relabelPermissions) 
	{
        ...
        $permissionList['membergroup'] = array_merge(
            array(
				...
				'tp_noapproval' => array(false, 'tp', 'tp'),
    ...
    public static function hookBuffer($buffer)
    {
        ...
        $string = '<a target="_blank" href="https://www.tinyportal.net" title="TinyPortal">TinyPortal 2.0.0 RC1</a> &copy; <a href="' . $scripturl . '?action=tportal;sa=credits" title="Credits">2005-2020</a>';
