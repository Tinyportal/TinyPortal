...
class Mentions extends Base
{
	...
	public function addJS()
	{
		...
		if (!empty($this->modSettings['enable_mentions']) && allowedTo('mention')) {
			loadJavaScriptFile('jquery.atwho.min.js', ['defer' => true, 'minimize' => false], 'tp_atwho');
			loadJavaScriptFile('jquery.caret.min.js', ['defer' => true, 'minimize' => false], 'tp_caret');
			loadJavaScriptFile('tinyportal/tinyPortalMentions.js', ['defer' => true, 'minimize' => false], 'tp_mentions');
		}
	}
