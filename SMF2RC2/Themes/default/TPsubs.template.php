...
function template_TPtagtopics_above()
{
	...
	echo '
	<div class="tborder" style="margin-bottom: 3px;">
		<h3 class="titlebg"><span class="left"></span>' . $txt['tp-tagtopics'] . ' ' , tp_hidepanel('tagpanel4',true) , '</h3>
...
<div style="margin-bottom: 5px; overflow: hidden;">
	<h3' . (in_array($context['TPortal']['article']['frame'], array('theme','title')) ? ' class="' . $headerstyle . '"' : ' class="article_title"') . '><span class="left"></span>{article_shortdate} {article_title} </h3>
...
function template_subtab_above()
{
	...
	if(sizeof($context['TPortal']['subtabs'])>1)
	{
		...
		<div class="tborder" style="margin-bottom: 0.5em;">
			<h3 class="catbg"><span class="left"></span>' . $txt['tp-menus'] .'</h3>
...
function template_tpadm_above()
{
	...
	<div class="tborder" id="tpadmin_menu">
		<div class="tp_half">
			<h3 class="catbg"><span class="l"></span><span class="r"></span>' . $txt['tp-tpmenu'] .'</h3>
		</div>
