...
function template_main()
{
	...
	if($context['TPortal']['show_download']==0 && !allowedTo('tp_dlmanager'))
		...
		echo '
	<h3 class="titlebg"><span class="left"></span>',  $txt['tp-downloads'], '	</h3>
	<div>';
		$dlbuttons = array(
	...
	if($context['TPortal']['dlaction']=='' || $context['TPortal']['dlaction']=='cat')
	{
		...
		{
			echo '
		<h3 class="catbg" style="background-position: 0 -160px;"><span class="left" style="background-position: -20px -160px;"></span>' . $txt['tp-dlfeatured'] . '</h3>
	...
	<div class="roundframe">
		<h3 class="catbg" style="font-size: 95%; font-weight: normal;"><span class="left"></span>';
