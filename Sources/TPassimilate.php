...
function tpAddCopy($buffer)
{
	...
	$string = '<a target="_blank" href="https://www.tinyportal.net" title="TinyPortal">TinyPortal 1.6.4</a> &copy; <a href="' . $scripturl . '?action=tpmod;sa=credits" title="Credits">2005-2019</a>';
