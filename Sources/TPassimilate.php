...
// Dynamic body classes
  if (isset($_GET['board']) && !isset($_GET['topic'])) {
	...
	$bclass =  "cat" . $_GET['cat'];	
  } else {$bclass =  "tpcontnainer";}


	$string = '<a target="_blank" href="http://www.tinyportal.net" title="TinyPortal">TinyPortal</a> <a href="' . $scripturl . '?action=tpmod;sa=credits" title="TP 1.3R">&copy; 2005-2017</a>';
