			...
			<tbody>
				...
				<table class="multirow" width="100%">
					<tr class="windowbg2">
						...
						<td valign="top" width="80%"><input style="width: 92%;" name="tp_article_subject" type="text" value="'.htmlspecialchars_decode($mg['subject'], ENT_QUOTES).'"></td>
					</tr>
					<tr class="windowbg2">
				...
				elseif($mg['articletype']=='bbc')
					TP_bbcbox('TPadmin3','tp_article_body', htmlspecialchars_decode(strip_tags($mg['body']), ENT_QUOTES));
				else
