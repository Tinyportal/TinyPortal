<?php
// Version: TinyPortal 1.0; TPortal
...
// ]]></script>';
	...
	// show the linktree?
	if(in_array('linktree', $article['visual_options']))
		theme_linktree();
	
	render_template(article_renders((!empty($article['category_opts']['catlayout']) ? $article['category_opts']['catlayout'] : 1) , true));
}
