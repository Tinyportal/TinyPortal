	...
	<div>
		...
		if(isset($context['TPortal']['profile_articles']) && sizeof($context['TPortal']['profile_articles'])>0){
			foreach($context['TPortal']['profile_articles'] as $art){
				echo '
			<tr class="windowbg2">
				<td><a href="'.$art['href'].'" target="_blank">', $art['approved']==0 ? '(' : '' , $art['off']==1 ? '<i>' : '' , htmlspecialchars_decode($art['subject'], ENT_QUOTES), $art['off']==1 ? '</i>' : '' , $art['approved']==0 ? ')' : '' ,  '</td>
...
if(isset($context['TPortal']['profile_uploads']) && sizeof($context['TPortal']['profile_uploads'])>0){
	foreach($context['TPortal']['profile_uploads'] as $art){
		echo '
			<tr class="windowbg2">
				<td><a href="'.$art['href'].'" target="_blank">', $art['approved']==0 ? '(' : '' , htmlspecialchars_decode($art['name'], ENT_QUOTES), $art['approved']==0 ? ')' : '' ,  '</td>
