<?php
// Version: TinyPortal 1.0; TPprofile
...
function template_tp_articles()
{
	...
	<div>
		...
		echo '
			...
			<tr class="catbg">
				<td align="center" nowrap="nowrap">', $context['TPortal']['tpsort']=='subject' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tparticles;tpsort=subject">'.$txt['subject'].'</a></td>
				<td align="center" nowrap="nowrap">', ($context['TPortal']['tpsort']=='date'  || $context['TPortal']['tpsort']=='') ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tparticles;tpsort=date">'.$txt['tp-date'].'</a></td>
				<td align="center" nowrap="nowrap">', $context['TPortal']['tpsort']=='views' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tparticles;tpsort=views">'.$txt['tp-views'].'</a></td>
				<td align="center" nowrap="nowrap">'.$txt['tp-ratings'].'</td>
				<td align="center" nowrap="nowrap">', $context['TPortal']['tpsort']=='comments' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tparticles;tpsort=comments">'.$txt['tp-comments'].'</a></td>
				<td align="center" nowrap="nowrap">', $context['TPortal']['tpsort']=='category' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tparticles;tpsort=category">'.$txt['tp-category'].'</a></td>
		...
		if(isset($context['TPortal']['profile_articles']) && sizeof($context['TPortal']['profile_articles'])>0){
			foreach($context['TPortal']['profile_articles'] as $art){
				echo '
			<tr class="windowbg2">
				<td><a href="'.$art['href'].'" target="_blank">', $art['approved']==0 ? '(' : '' , $art['off']==1 ? '<i>' : '' , htmlspecialchars_decode($art['subject'], ENT_QUOTES, $context['character_set']), $art['off']==1 ? '</i>' : '' , $art['approved']==0 ? ')' : '' ,  '</td>
...
<h3 class="titlebg"><span class="left"></span>'.$txt['downloadsprofile'].'</h3>
	...
	echo '
			...
			<tr class="catbg">
				...
				<td align="center" nowrap="nowrap">', ($context['TPortal']['tpsort']=='created'  || $context['TPortal']['tpsort']=='') ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=created">'.$txt['tp-date'].'</a></td>
				<td align="center" nowrap="nowrap">', $context['TPortal']['tpsort']=='views' ? '<img src="' .$settings['tp_images_url']. '/TPsort_down.gif" alt="" /> ' : '' ,'<a href="'.$scripturl.'?action=profile;u='.$context['TPortal']['memID'].';sa=tpdownloads;tpsort=views">'.$txt['tp-views'].'</a></td>
				<td align="center" nowrap="nowrap">'.$txt['tp-ratings'].'</td>
...
if(isset($context['TPortal']['profile_uploads']) && sizeof($context['TPortal']['profile_uploads'])>0){
	foreach($context['TPortal']['profile_uploads'] as $art){
		echo '
			<tr class="windowbg2">
				<td><a href="'.$art['href'].'" target="_blank">', $art['approved']==0 ? '(' : '' , htmlspecialchars_decode($art['name'], ENT_QUOTES, $context['character_set']), $art['approved']==0 ? ')' : '' ,  '</td>
