...
global $settings, $scripturl, $boarddir, $context, $language, $smcFunc, $db_prefix;
...
<div style="margin: 0; padding: 8px;" class="catbg">Install/Upgrade v1.0 RC1 for SMF 2.0 RC3 &copy;2004-2010</div>
...
else
{
	...
	itpdb_query("INSERT INTO " . $tp_prefix . "blocks VALUES (3, 6, 'theme', 'Online', '', '-1,0,2,3,-2', 3, 20, 0, '0', 1, 0, '', 'actio=allpages', '-2','','')");
	itpdb_query("INSERT INTO " . $tp_prefix . "blocks VALUES (4, 12, 'theme', 'Recent', '10', '-1,0,1', 2, 0, 0, '', 1, 0, '', 'actio=allpages', '','','')");
...
if(checkTable('articles'))
{
	...
	checkColumn('articles','ID_THEME','CHANGE `ID_THEME` `id_theme` smallint(6) default 0 NOT NULL',true);
	checkColumn('articles','authorID','CHANGE `authorID` `author_id` int default 0 NOT NULL',true);
...
if(checkTable('dlmanager'))
{
	...
	checkColumn('dlmanager','authorID','CHANGE `authorID` `author_id` int default 0 NOT NULL',true);
}
else
{
