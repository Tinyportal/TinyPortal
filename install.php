...
if ($manual) {
	...
	<html xmlns="http://www.w3.org/1999/xhtml"><head>
		<title>TinyPortal - v2.0.0 RC1 for '.$forumVersion.'</title>
...
<div class="cat_bar" style="position:relative;"><a href="javascript:void(0)" style="position:absolute;top:5px;right:5px;font-weight:bold;color:red;" onclick="closeNav()"><img src="' . $boardurl . '/Themes/default/images/tinyportal/TPdelete2.png" alt="*" /></a><h3 class="catbg">Install/Upgrade TinyPortal v2.0.0 RC1 for '.$forumVersion.'<h3/></div>
	...
	if ($smcFunc['db_num_rows']($request) < 1) {
		$vars = array(
			'var1' =>array(
				...
				'value5' => -2,
				'subtype' => '',
				'value7' => 'catlayout=1|layout=1|leftpanel=1|rightpanel=1|toppanel=1|centerpanel=1|lowerpanel=1|bottompanel=1',
				'value8' => 'Features',
				'subtype2' => 0,
				'value9' => '',
			),
